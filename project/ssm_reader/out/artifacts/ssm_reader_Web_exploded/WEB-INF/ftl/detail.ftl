    ...
    <script>
        ...
        $(function () {
            ...
            $("#btnEvaluation").click(function () {
                $("#score").raty({});//转化为星型组件
                $("#dlgEvaluation").modal("show");//显示评论对话框
            })
    ...
    <div class="reply pl-2 pr-2">
            ...
            <div>
                <div>
                    ...
                    <span class="mr-2 small pt-1">${eva.member.nickname}</span>
                    <span class="stars mr-2" data-score="${eva.score}"></span>

                    <button type="button" data-evaluation-id="${eva.evaluationId}"
