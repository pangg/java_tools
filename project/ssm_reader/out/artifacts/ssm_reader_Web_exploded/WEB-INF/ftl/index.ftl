...
<script>
    ...
    function loadMore(isReload){
        ...
        var order=$("#order").val();
        $.get("/book/findPage",{p:nextPage,categoryId:categoryId,order:order},function (data) {
            console.info(data)
            var list=data.records;
            for(var i=0;i<list.length;i++){
                var book= data.records[i];
                /*将数据结合tpl，生成新的html*/
...
<div class="container">
    ...
    <div class="row mt-2">
        ...
        <div class="col-8 mt-2">
                ...
                <#list categoryList as category>
                    ...
                    <#if category_has_next>|</#if><#--如果后面还有数据，就执行里面的内容-->
                </#list>
    ...
    <button type="button" id="btnMore" onclick="loadMore(false)" data-next-page="1" class="mb-5 btn btn-outline-primary btn-lg btn-block">
        点击加载更多...
    </button>
